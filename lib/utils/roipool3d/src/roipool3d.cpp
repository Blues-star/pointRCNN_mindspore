...
extern "C" int ms_roipool3d_gpu(int nparam, void **params, int *ndims, int64_t **shapes, const char **dtypes, void *stream, void *extra){
    auto tensors = get_torch_tensors(nparam, params, ndims, shapes, dtypes, c10::kCUDA);
    roipool3d_gpu(tensors[0], tensors[1], tensors[2], tensors[3], tensors[4]);
    return 0;
}
...
extern "C" int ms_pts_in_boxes3d_cpu(int nparam, void **params, int *ndims, int64_t **shapes, const char **dtypes, void *stream, void *extra){
...
extern "C" int ms_roipool3d_cpu(int nparam, void **params, int *ndims, int64_t **shapes, const char **dtypes, void *stream, void *extra){
    auto tensors = get_torch_tensors(nparam, params, ndims, shapes, dtypes, c10::kCPU);
    roipool3d_cpu(tensors[0], tensors[1], tensors[2], tensors[3], tensors[4], tensors[5]);
    return 0;
}
